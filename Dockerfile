...
RUN wget https://mirror.nodesdirect.com/apache/tomcat/tomcat-9/v9.0.52/bin/apache-tomcat-9.0.52.tar.gz
RUN tar -zxvf apache-tomcat-9.0.52.tar.gz -C /opt/tomcat --strip-components=1
